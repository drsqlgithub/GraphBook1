----------------------------------------------------------------------------------------------------------
--********************************************************************************************************
--This file is used to generate a data set that we will use in file 002 to performance test 
...
ELSE IF '$(DataSetName)' = 'WideSet'
	insert into @levelCriteria
	values (1,1),(2,300),(3,5000),(4,10000),(5,40000)
ELSE IF '$(DataSetName)' = 'DeepSet'
	insert into @levelCriteria
...
ELSE IF '$(DataSetName)' = 'SuperHugeSet' --This could take a really long time to create.
	INSERT INTO @levelCriteria
