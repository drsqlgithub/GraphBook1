...
----------------------------------------------------------------------------------------------------------
--********************************************************************************************************
--This code creates the database that the data generator uses. The data generator code is really
--straightforward, and it allows you to generate a pretty decent set of sample data.
--
--The setup file is used to load a table with random values based on a pattern
--The script producer outputs a script you can use to load your graph example
--********************************************************************************************************
----------------------------------------------------------------------------------------------------------
...
:setvar Databasename GraphDBTests_DataGenerator
