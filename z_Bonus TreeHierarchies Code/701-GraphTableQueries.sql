...
SELECT  DISTINCT Person1.UserName AS FromUserName, ThroughPerson.UserName AS ThroughPersonName, Person2.UserName AS ToUserName
FROM   SocialGraph.Person AS Person1,
...
--METHOD 1 - Use JOINS to get proper Node tables and use MATCH function
...
GO
--METHOD 2. Use Edge as a relational Many To Many
