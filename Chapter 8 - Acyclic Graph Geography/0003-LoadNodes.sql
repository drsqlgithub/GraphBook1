USE ImagesDirectory
GO
DELETE Locations.RelatedTo
DELETE Locations.Item;
DELETE Locations.RelationshipType
...
INSERT INTO Locations.RelationshipType (RelationshipType, Description)
...
EXEC Locations.ItemType$Maintain 'Resort','Full Theme Park Resort','A group of items that could stand alone, which RelatedTo theme parks'
...
INSERT INTO Locations_UI.Item_RelatedTo_Item
(    ItemName,    ToItemName, RelationshipType)
VALUES
...
SELECT *
FROM    Locations_UI.Item_RelatedTo_Item