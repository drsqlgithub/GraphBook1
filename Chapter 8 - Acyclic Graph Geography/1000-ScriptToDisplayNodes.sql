...
DECLARE @NodeList nvarchar(4000) = 'Locations.Item.ItemName'

--list of edges in format schema.edgeTable
DECLARE @EdgeList nvarchar(4000) = 'Locations.RelatedTo'

DECLARE @EdgeAttributeExpression nvarchar(4000) = 'RelationshipType'
