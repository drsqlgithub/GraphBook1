...
WITH FromTo AS 
(
SELECT ContributedTo.FromPersonId AS FromPersonId, ContributedTo2.FromPersonId AS ToPersonId, Title.Name AS TitleName
FROM  RelationalEdge.ContributedTo
		JOIN RelationalEdge.ContributedTo AS ContributedTo2
			ON ContributedTo.ToTitleId = ContributedTo2.ToTitleId
		JOIN Imdb.Title
			ON Title.TitleId = ContributedTo.ToTitleId
WHERE ContributedTo.FromPersonId <>  ContributedTo2.FromPersonId			)
