...
--will place the database in your default dirrectory
...
:setvar Databasename BillOfMaterialsExample

--useServer or specify
:SETVAR Collation UseServer

:setvar PrimaryFileGroupSize 1GB
:setvar PrimaryFileGroupMaxSize 2GB
:setvar PrimaryFileGroupFileGrowth 1GB
--put alternative file location here. NONE will put the file in the default
:setvar PrimaryFileGroupDirectoryOverride "NONE"


:setvar LogFileSize 500MB
:setvar LogFileMaxSize 2GB
:setvar LogFileGrowth 500MB
--put alternative file location here. NONE will put the file in the default
:setvar LogDirectoryOverride "NONE"

--will drop the database if it already exists. Great for tesing, terrible for prod databases!
